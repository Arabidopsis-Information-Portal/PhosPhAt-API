...
# 'getExperimentalHotspotData' is the method used to retrieve experimental
# hotspot data from the remote host PhosPhAt. Different methods retrieve
# different kinds of data. We obtained a list of methods that could be called
# through personal communication with PhosPhAt.
API_METHOD = 'getExperimentalHotspotData'
...
def search(args):
    ...
    #    - the method used to retrieve experimental hotspot data (API_METHOD)
    #
